...
import { ArrowRight, Leaf, Shield, Award, CheckCircle2, ChevronRight, ChevronLeft, Star, Users, Phone, MapPin, Mail, ClipboardList, Building2, HelpingHand, CheckSquare, Globe, Sparkles, Clock } from "lucide-react";
...
const PRODUCTS: ProductCard[] = [
  ...
  },
  {
    ...
    category: "All-in-One Blocks",
    desc: "Ready-to-fruit colonized substrate blocks, ideal for agricultural schools, training, and household startups.",
    href: "/spawn/growing-kits",
  },
];
          ...
          <div className="max-w-7xl mx-auto rounded-[2.5rem] overflow-hidden border border-[#e6e4dc] bg-white shadow-xl grid grid-cols-1 lg:grid-cols-12 items-stretch min-h-[70vh]">
            ...
            <div className="lg:col-span-6 bg-[#1c3c24] text-white p-10 md:p-16 flex flex-col justify-center space-y-8 relative overflow-hidden">
              ...
              <span className="text-[10px] text-[#7baa6b] font-mono uppercase tracking-widest block font-black relative z-10">
                SporoNova &bull; Agricultural Spawn Manufacturer
              </span>
              <h1 className="text-white font-display text-4xl md:text-5xl lg:text-6xl font-black tracking-tight leading-tight relative z-10">
                Premium Mushroom Spawn <br />
                for <span className="text-[#7baa6b]">Better Harvests</span>
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4 relative z-10">
                ...
                >
                  <Phone className="w-3.5 h-3.5 text-[#7baa6b]" /> Talk to an Expert
                </Link>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto -mt-12 bg-white rounded-3xl border border-[#e6e4dc]/80 shadow-lg p-6 md:py-8 md:px-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex items-start gap-4">
              <div className="p-3 bg-[#f9faf7] border border-[#e6e4dc] rounded-2xl shrink-0">
                <Leaf className="w-5 h-5 text-[#4e8c4a]" />
              </div>
              <div className="space-y-1">
                <span className="font-display font-extrabold text-gray-900 text-base block leading-none">14+</span>
                <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider block">Mushroom Varieties</span>
                <span className="text-[9px] text-gray-400 font-semibold block">Including Shiitake & more</span>
              </div>
            </div>

            <div className="flex items-start gap-4">
              <div className="p-3 bg-[#f9faf7] border border-[#e6e4dc] rounded-2xl shrink-0">
                <Award className="w-5 h-5 text-[#4e8c4a]" />
              </div>
              <div className="space-y-1">
                <span className="font-display font-extrabold text-gray-900 text-base block leading-none">50%</span>
                <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider block">Higher Yield</span>
                <span className="text-[9px] text-gray-400 font-semibold block">Compared to grain spawn</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                <span className="font-display font-extrabold text-gray-900 text-base block leading-none">3 Months</span>
                <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider block">Shelf Life</span>
                <span className="text-[9px] text-gray-400 font-semibold block">At 4°C temperature</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                <span className="font-display font-extrabold text-gray-900 text-base block leading-none">100%</span>
                <span className="text-[10px] text-gray-500 font-bold uppercase tracking-wider block">Organic & Chemical Free</span>
                <span className="text-[9px] text-gray-400 font-semibold block">Pure & safe cultivation</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 space-y-8">
            <div className="space-y-3">
              ...
              <h2 className="text-[#1c3c24] font-display text-3xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight">
                Science and Commitment Behind Every Kernel
              </h2>
            </div>
        ...
        <section id="products" className="py-24 bg-white border-t border-b border-[#e6e4dc] px-6">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-stretch">
                ...
                <div className="w-full lg:w-2/3 bg-[#f2f7f2]/50 border border-[#e6e4dc] rounded-[2rem] p-8 md:p-10 flex flex-col md:flex-row justify-between items-center gap-8 shadow-sm hover:shadow-md transition-all duration-300 group">
                  <div className="space-y-4 max-w-lg">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] text-gray-500 font-mono block uppercase font-bold tracking-wider">{PRODUCTS[0].category}</span>
                    </div>
                ...
                <div className="w-full lg:w-1/3 bg-[#f4f5f0]/50 border border-[#e6e4dc] rounded-[2rem] p-8 md:p-10 flex flex-col justify-between shadow-sm hover:shadow-md transition-all duration-300 group">
                  <div className="space-y-4">
                    <div className="flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#4e8c4a]" />
                      <span className="text-[10px] text-gray-500 font-mono block uppercase font-bold tracking-wider">{PRODUCTS[1].category}</span>
                    </div>
                    <h4 className="text-[#1c3c24] font-display font-extrabold text-xl md:text-2xl leading-snug group-hover:text-[#4e8c4a] transition-colors">
                      {PRODUCTS[1].name}
                    </h4>
              ...
              <div className="flex flex-col lg:flex-row gap-8 items-stretch">
                ...
                <div className="w-full lg:w-1/3 bg-white border border-[#e6e4dc] rounded-[2rem] p-8 md:p-10 flex flex-col justify-between shadow-sm hover:shadow-md transition-all duration-300 group">
                  <div className="space-y-4">
                    <div className="flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#4e8c4a]" />
                      <span className="text-[10px] text-gray-500 font-mono block uppercase font-bold tracking-wider">{PRODUCTS[2].category}</span>
                    </div>
                    <h4 className="text-[#1c3c24] font-display font-extrabold text-xl md:text-2xl leading-snug group-hover:text-[#4e8c4a] transition-colors">
                      {PRODUCTS[2].name}
                    </h4>
                ...
                <div className="w-full lg:w-2/3 bg-[#fcfbfa] border border-[#e6e4dc] rounded-[2rem] p-8 md:p-10 flex flex-col md:flex-row justify-between items-center gap-8 shadow-sm hover:shadow-md transition-all duration-300 group">
                  <div className="space-y-4 max-w-lg">
                    <div className="flex items-center gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#4e8c4a]" />
                      <span className="text-[10px] text-gray-500 font-mono block uppercase font-bold tracking-wider">{PRODUCTS[3].category}</span>
                    </div>
                    <h4 className="text-[#1c3c24] font-display font-extrabold text-xl md:text-2xl leading-snug group-hover:text-[#4e8c4a] transition-colors">
                      {PRODUCTS[3].name}
                    </h4>
              ...
              {/* Row 3: Growing Kits */}
              <div className="w-full bg-white border border-[#e6e4dc] rounded-[2rem] p-8 md:p-10 flex flex-col md:flex-row md:items-center justify-between gap-8 shadow-sm hover:shadow-md transition-all duration-300 group">
                <div className="space-y-4 max-w-2xl">
                  <div className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#4e8c4a]" />
                    <span className="text-[10px] text-gray-500 font-mono block uppercase font-bold tracking-wider">{PRODUCTS[4].category}</span>
                  </div>
                  <h4 className="text-[#1c3c24] font-display font-extrabold text-xl md:text-2xl leading-snug group-hover:text-[#4e8c4a] transition-colors">
                    {PRODUCTS[4].name}
                  </h4>
                ...
                <div className="shrink-0 flex items-center gap-6">
                  <div className="w-24 h-24 rounded-xl bg-[#f9faf7] border border-[#e6e4dc] relative overflow-hidden flex items-center justify-center">
                    <MushroomStructureCanvas hideSidebar={true} />
                  </div>
                  <Link
                    href={PRODUCTS[4].href}
                    className="inline-flex items-center justify-center px-8 py-3.5 bg-[#1c3c24] hover:bg-[#4e8c4a] rounded-full text-[10px] font-bold uppercase tracking-wider text-white transition-all"
                  >
                    View Specifications &rarr;
                  </Link>
                </div>
          ...
          >
            <div className="md:col-span-8 space-y-3">
              ...
              <h2 className="font-display text-3xl md:text-5xl font-black tracking-tight text-[#1c3c24] leading-tight">
                Why Growers Choose <span className="text-[#4e8c4a]">SporoNova</span>
              </h2>
            </div>
            <div className="md:col-span-4">
              <p className="text-gray-500 text-xs sm:text-sm font-semibold leading-relaxed">
                Our standard manufacturing protocols solve major cultivation hazards, ensuring optimal biological efficiency and reproducible harvest yields.
              </p>
            </div>
          </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="bg-[#f9faf7]/70 border-l border-r border-b border-[#e6e4dc] py-10 px-4 md:px-6 rounded-b-3xl relative overflow-hidden">
              ...
              <div className="animate-marquee flex gap-6">
                {CREDENTIALS.concat(CREDENTIALS).concat(CREDENTIALS).map((cred, idx) => (
                  <div
                    key={`${cred.title}-${idx}`}
