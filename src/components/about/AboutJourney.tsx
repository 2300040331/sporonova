...
const milestones = [
  {
    ...
    description: "Started with a vision to modernize mushroom cultivation through scientific methods",
  },
  {
    step: 2,
    title: "Laboratory Development",
    description: "Established GMP-compliant cleanroom facilities with advanced biological protocols",
  },
  {
    step: 3,
    title: "Advanced Liquid Spawn Technology",
    description: "Pioneered liquid spawn broth technology for faster colonization",
  },
  {
    step: 4,
    title: "Commercial Production",
    description: "Scaled operations to serve commercial farmers across multiple states",
  },
  {
    step: 5,
    title: "Government Collaborations",
    description: "Partnered with JICA, NHB, and state horticulture departments",
  },
  {
    step: 6,
    title: "National Expansion",
    description: "Expanded distribution network to 200+ farmers across India",
  },
  {
    step: 7,
    title: "Future Global Growth",
    description: "Building next-generation spawn solutions with AI-powered quality control",
  },
];
