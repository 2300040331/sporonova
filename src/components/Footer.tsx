        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 text-xs leading-relaxed max-w-sm">
              Empowering farmers, entrepreneurs, and commercial growers with premium certified mushroom spawn and scientific cultivation solutions.
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-xs text-gray-600 font-medium">
              <li><Link href="/spawn/liquid-spawn" className="hover:text-[#4e8c4a] transition-colors">Liquid Spawn Broth</Link></li>
              <li><Link href="/spawn/grain-spawn" className="hover:text-[#4e8c4a] transition-colors">Grain Spawn Jars/Bags</Link></li>
              <li><Link href="/spawn/mother-culture" className="hover:text-[#4e8c4a] transition-colors">Mother Culture Agar</Link></li>
              <li><Link href="/spawn/commercial-spawn" className="hover:text-[#4e8c4a] transition-colors">Commercial Spawn Packs</Link></li>
              <li><Link href="/spawn/growing-kits" className="hover:text-[#4e8c4a] transition-colors">Mushroom Growing Kits</Link></li>
            </ul>
          </div>
